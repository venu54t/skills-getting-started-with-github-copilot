...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball practice and friendly games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "avery@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, fitness, and water safety sessions",
    ...
    "Drama Club": {
        "description": "Acting, staging, and performance practice for school plays",
